package net.chairmanfed.noxerna.item.equipment.armour;
...
public class NoxernaArmourMaterials {
    public static final DeferredRegister<ArmorMaterial> ARMOUR_MATERIAL = DeferredRegister.create(
            Registries.ARMOR_MATERIAL, TheNoxerna.MODID);
    public static final Holder<ArmorMaterial> ROCKHIDE = ARMOUR_MATERIAL.register(
        ...
        map.put(ArmorItem.Type.BODY, 4);
                    ...
                    List.of(new ArmorMaterial.Layer(TheNoxerna.prefix("rockhide"))),
                    0, 0));
    public static final Holder<ArmorMaterial> HEART = ARMOUR_MATERIAL.register(
            "heart", () -> new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
                ...
                map.put(ArmorItem.Type.BODY, 1);
                    ...
                    List.of(new ArmorMaterial.Layer(TheNoxerna.prefix("heart"))),
                    0.0F, 0.0F));
    public static final Holder<ArmorMaterial> EXOSKELETON = ARMOUR_MATERIAL.register(
            "exoskeleton", () -> new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
                ...
                map.put(ArmorItem.Type.BODY, 2);
                    ...
                    List.of(new ArmorMaterial.Layer(TheNoxerna.prefix("exoskeleton"))),
                    1.0F, 0.01F));
    public static final Holder<ArmorMaterial> FERREBRIS = ARMOUR_MATERIAL.register(
