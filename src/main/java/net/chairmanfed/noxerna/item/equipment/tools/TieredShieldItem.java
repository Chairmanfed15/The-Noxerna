...
public class TieredShieldItem extends TieredItem implements Equipable {
    ...
    public boolean isValidRepairItem(ItemStack itemStack, ItemStack repair) {
        return this.getTier().getRepairIngredient().test(repair) || super.isValidRepairItem(itemStack, repair);
    }
    @Override
