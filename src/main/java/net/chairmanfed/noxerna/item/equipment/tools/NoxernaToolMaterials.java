...
public class NoxernaToolMaterials {
    ...
    public static final Tier OBSCUPRUM = new SimpleTier(
            NoxernaTags.BlockTags.INCORRECT_FOR_NOXSTONE_TOOL, 723, 13.0f, 0.0f,
            14, () -> Ingredient.of(NoxernaTags.ItemTags.OBSCUPRUM_INGOTS));
